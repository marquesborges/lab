...
PDFFile = pdfquery.PDFQuery("C:\\Users\\alexandreborges\\Downloads\\nota_73303.pdf")
...
#PDFFile.tree.write("C:\\Users\\alexandreborges\\Downloads\\Nota de Corretagem_Hugo.xml", pretty_print=True, encoding="utf-8")
...
for NotaKey in Cabecalho.keys():
    try:
        ...
        Cabecalho[NotaKey] = Valor[len(Valor)-1].text.strip()
    except:
        print(NotaKey)
print('+------------ N O T A ------------+')
print(Cabecalho)
